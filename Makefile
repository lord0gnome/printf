...
#    Updated: 2016/02/18 13:11:18 by guiricha         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC_NAME = ft_length_funcs.c ft_parse_and_store.c ft_print_all.c \
		   ft_parse_hex.c ft_parse_oct.c ft_printf.c ft_putll.c \
		   ft_small_functions.c ft_very_small_functions.c ft_putl.c \
		   ft_atoi.c ft_putchar.c ft_putnbr.c ft_putstr.c ft_strcpy.c \
